...
const SUB_PATH = process.env.SUB_PATH || '666';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || '7b8bddff-f6c3-4e47-acfc-04649451c752'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const NAME = process.env.NAME || 'yyy';                        // 节点名称
